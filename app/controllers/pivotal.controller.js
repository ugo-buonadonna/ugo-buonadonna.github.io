...
app.controller('PivotalTrackerCtrl', ['$scope', '$http', 'PivotalTracker', function ($scope, $http, PivotalTracker) {
    ...
    try {
        for (var _iterator = new Array(20).keys()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var i = _step.value;
    ...
    var calculateData = function calculateData(currentIteration) {
        ...
        try {
            for (var _iterator2 = $scope.currentIterationStories[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    $scope.setRemainingMandays = function (sprintNumber) {
